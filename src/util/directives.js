...
Vue.directive('dialogDrag', {
  bind(el, binding, vnode, oldVnode) {
    ...
    const minus=el.querySelector('.el-icon-minus')
        ...
        if (clientX > EloffsetLeft && clientX < EloffsetLeft + elW && clientY > EloffsetTop && clientY < EloffsetTop + 100) {
          ...
          document.onmousemove = function (e) {
            ...
            if (clientX > EloffsetLeft && clientX < EloffsetLeft + 10) {
              ...
              //console.log('EloffsetLeft',EloffsetLeft)
              //往左拖拽
              if (clientX > e.clientX) {
                if(dragDom.style.width >= document.body.clientWidth){
                  dragDom.style.width=document.body.clientWidth
                }else{
